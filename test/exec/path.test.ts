...
describe('extendPath', () => {
  it('prepends the install dirs once and keeps the existing PATH', () => {
    ...
    expect(added).toEqual(['/home/u/.local/bin', '/home/u/.local/share/fnm', '/home/u/.local/share/fnm/aliases/default/bin', '/home/u/go/bin', '/usr/local/bin']);
    expect(env.PATH).toBe('/home/u/.local/bin:/home/u/.local/share/fnm:/home/u/.local/share/fnm/aliases/default/bin:/home/u/go/bin:/usr/local/bin:/usr/bin:/bin');
  ...
  it('skips dirs already on PATH (trailing slash tolerant) and handles an empty PATH', () => {
    ...
    expect(extendPath(linux, env)).toEqual(['/home/u/.local/share/fnm', '/home/u/.local/share/fnm/aliases/default/bin', '/home/u/go/bin']);
